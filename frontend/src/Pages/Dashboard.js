...
import CurrentDayOverview from '../components/dashboard/CurrentDayOverview';
import SatisfactionPrompt from '../components/satisfaction/SatisfactionPrompt';
...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 px-4 py-8">
      ...
      <AnimatePresence>
        {showSatisfactionPrompt && promptDate && (
          <SatisfactionPrompt 
            today={promptDate}
